    ...
    return (
        <div className="experience">
            ...
            <div className="experience-body">
                ...
                <Window head="" body="" img="https://media.glassdoor.com/l/1791038/tablt-office.jpg" backgroundColor="--background" color="--primary" height="40vh" width="480px" margin="0 0 0 0"/>
